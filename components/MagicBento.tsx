...
const cardData: BentoCardProps[] = [
	{
		...
		description: "Extract invoice data with 99% accuracy",
	...
	},
	{
		...
		description: "Monitor invoices and payments instantly",
		label: "Overview",
		backgroundImage:
	...
	},
	{
		...
		description: "PDF, images, emails - we handle it all",
		label: "Flexibility",
		backgroundImage:
	...
	},
	{
		...
		description: "Auto-categorize and process invoices",
		label: "Efficiency",
		backgroundImage:
					...
					const cardProps = {
						...
						style: {
							...
							backgroundImage: card.backgroundImage
								? `linear-gradient(rgba(6, 0, 16, 0.75), rgba(6, 0, 16, 0.85)), url(${card.backgroundImage})`
								: undefined,
