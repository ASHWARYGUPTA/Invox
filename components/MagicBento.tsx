...
export interface BentoProps {
  ...
  // optional: set explicit width for the whole bento (e.g. '800px' or '100%')
  bentoWidth?: string;
  // optional max-width applied when bentoWidth is '100%' to constrain layout
  bentoMaxWidth?: string;
}
...
const cardData: BentoCardProps[] = [
  {
    ...
    label: "Insights",
    backgroundImage: "/analytics-bg.jpg", // Add your image path
  },
  {
    color: "#060010",
    title: "Dashboard",
    ...
    label: "Overview",
    backgroundImage: "/dashboard-bg.jpg", // Add your image path
  },
  {
    color: "#060010",
    title: "Collaboration",
    ...
    label: "Teamwork",
    backgroundImage: "/collaboration-bg.jpg", // Add your image path
  },
  {
    color: "#060010",
    title: "Automation",
    ...
    label: "Efficiency",
    backgroundImage: "/automation-bg.jpg", // Add your image path
  },
  {
    color: "#060010",
    title: "Integration",
    ...
    label: "Connectivity",
    backgroundImage: "/integration-bg.jpg", // Add your image path
  },
  {
    color: "#060010",
    title: "Security",
    ...
    label: "Protection",
    backgroundImage: "/security-bg.jpg", // Add your image path
  },
];
...
const BentoCardGrid: React.FC<{
  ...
  bentoWidth?: string;
  bentoMaxWidth?: string;
}> = ({ children, gridRef, bentoWidth = "100%", bentoMaxWidth = "54rem" }) => (
  <div
    className="bento-section grid gap-2 p-3 select-none relative"
    style={{
      fontSize: "clamp(1rem, 0.9rem + 0.5vw, 1.5rem)",
      width: bentoWidth,
      maxWidth: bentoWidth === "100%" ? bentoMaxWidth : undefined,
      margin: "0 auto",
    }}
    ref={gridRef}
  >
